...
class SupplysystemA(BaseEnvSim):
    """
        ...
        **kwargs: Any,
        ...
        state_var_tuple = (
            ...
            StateVar(
                ...
                ext_id="cHP.P_el", #Verbrauch BHKW
                is_ext_output=True,
            ...
            StateVar(
                name="s_P_gs_combinedheatpower", #Verbrauch BHKW
                ext_id="cHP.P_gs",
                is_ext_output=True,
                is_agent_observation=mpc_state,
                low_value=0,
            ...
            StateVar(
                ...
                ext_id="condensingBoiler.P_gs", #Verbrauch BWT
                is_ext_output=True,
                is_agent_observation=mpc_state,
                low_value=0,
                high_value=8000000,
            ...
            StateVar(
                ...
                ext_id="immersionHeater.P_el", #Verbrauch Heizstab
                is_ext_output=True,
                is_agent_observation=mpc_state,
                low_value=0,
                high_value=150000,
    ...
    def reset(
        ...
        *,
        ...
        # to get the same number of random calls to generate the same dates and temperatures for supplysystem a and b...
        _ = self.np_random.uniform(self.temperature_heat_init_min, self.temperature_heat_init_max)
    ...
    def render(self, mode="human", name_suffix=""):
        ...
        axes[0].set_yticklabels(["Blockheizkraftwerk", "Gasbrennwertgerät", "Tauchsieder"])
        im = axes[0].imshow(
        ...
        axes[1].plot(
            x,
            y["s_temp_heat_storage_lo"] - 273.15,
            color=(192 / 255, 0, 0),
            linestyle="dashed",
            label="Wärmespeicher (un)",
        )
        # settings
        ...
        # (3) - Prices
        axes[2].plot(x, y["s_price_electricity"], color=(1.0, 0.75, 0.0), label="Strom")
        axes[2].plot(x, y["s_price_gas"], color=(0.65, 0.65, 0.65), label="Erdgas")
        axes[2].set_ylabel("Energiepreis (netto) [€/kWh]")
        ...
        axes[5].set_ylabel("Rewards [€-äquiv.]")
