...
def main() -> None:
    ...
    config_experiment_1_learn = {
        "settings": {"n_environments": 4, "n_episodes_learn": 1, "episode_duration": 259200, "plot_interval": 100},
        "agent_specific": {
    ...
    experiment_1.learn("ppo_lstm_test", "experiment_1")
    ...
    config_experiment_1_play = {
        ...
        "agent_specific": {"policy_kwargs": {"net_arch": [500, 400, 300]}},
    ...
    experiment_1.play("ppo_lstm_test", "experiment_1")
