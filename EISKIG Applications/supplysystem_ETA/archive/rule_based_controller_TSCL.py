...
class RuleBasedController(RuleBased):
    ...
    def control_rules(self, observation) -> np.ndarray:
        ...
        # action["bSetStatusOn_HeatExchanger1"] = 0
        # action["bSetStatusOn_CHP1"] = 0
        # action["bSetStatusOn_CHP2"] = 0
        # action["bSetStatusOn_CondensingBoiler"] = 0
        # action["bSetStatusOn_VSIStorage"] = 0
        # action["bLoading_VSISystem"] = 0
        # action["bSetStatusOn_HVFASystem_HNLT"] = 0
        # action["bLoading_HVFASystem_HNLT"] = 0
        ...
        action["bSetStatusOn_HeatPump2"] = 0
        ...
        # action["HeatPump2_bAlgorithmModeActivated"] = 1

        # action["CN_CentralMachineCoolingSystem_bAlgorithmModeActivated"] = 0
        # action["CN_CentralMachineCoolingSystem_bSetStatusOnAlgorithm"] = 1
        # action["CN_CentralMachineCoolingSystem_bAlgorithmModeActivated"] = 1
