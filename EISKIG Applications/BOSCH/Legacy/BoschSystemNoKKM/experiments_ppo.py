...
def main() -> None:
    ...
    config_experiment_1_learn = {
        ...
        "environment_specific": {"discretize_action_space": True, "up_down_discrete": True, "use_policy_shaping": True, "plot_only_env1": True, "activate_load_recalc": True},
        "agent_specific": {
            "n_steps": 256,
            "batch_size": 256,
...
# ca 100000 params vs 700000 params ca.
    ...
    ts = time.time()
    experiment_1.learn("ppo_nokkm", "agent_2", run_description=run_description, use_eval_cb=False, n_eval_envs=1, eval_freq=200000/experiment_1.config.settings.n_environments)
    ts2 =time.time()
    print(ts2-ts)
