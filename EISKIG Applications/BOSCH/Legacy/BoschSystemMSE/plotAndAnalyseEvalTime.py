...
combined_df = df_list[0]#pd.concat(df_list, axis=0, ignore_index=True)
...
plt.plot(df.index, df['P_el_KKM_kw'], color='blue')  # Plotting the data
plt.xlabel('Time')  # Label for the x-axis
plt.ylabel('Power CC in kw')  # Label for the y-axis
