...
class Test_WT(BaseEnvSim):
        ...
        **kwargs: Any,
        ...
        state_var_tuple = (
            ...
            StateVar(
                ...
                ext_scale_add = -273.15,
                abort_condition_max=50,
                abort_condition_min=12,
                low_value = 0,
                high_value=100
            )
        )
    ...
    def calc_reward(self):
        ...
        self.state["reward_switching"] = (
            ...
            #     0.01,
            # )
            -1*abs(self.state["s_u"] - self.state_backup["s_u"])/self.sampling_time
        )
    ...
    def render(self, mode="human", name_suffix=""):
        ...
        # )
        fig = px.line(self.episode_df, x=self.episode_df.index, y=["T","s_u","reward_total"])
        # wandb.log({self.config_run.name + "_"
        #         + str(self.n_episodes) + "-"
        #         + str(self.env_id) + "_episode": fig})
