...
def main() -> None:
    ...
    config_rb = {
        ...
        "environment_specific": {
            ...
            "scenario_time_end": "2018-12-31 23:00",
    ...
    config_ppo_play = {
        ...
        "agent_specific": {"policy_kwargs": {"device":"cuda"}},
        "environment_specific": {
    ...
    # experiment_ppo.play("compare_FY_2018", "agent_12")
    experiment_ppo.play("compare_FY_2018", "agent_8")
    experiment_rb.play("compare_FY_2018", "rb")
