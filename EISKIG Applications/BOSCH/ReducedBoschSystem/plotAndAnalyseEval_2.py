...
#folder_path = r'C:\Users\Askari-Badouee_David\Documents\GitHub\experimentshr_ast\experiments_hr\ReducedBoschSystem\results\compare_ppo_rb3'
folder_path = r'C:\Users\Askari-Badouee_David\Documents\GitHub\experimentshr_ast\experiments_hr\ReducedBoschSystem\results\compare_FY_split'

# Filenames list
filenames = [
    # "rbfb_0024-01_all-episodes.csv",
    "rb_0120-01_all-episodes.csv",
    # "rbb_0024-01_all-episodes.csv",
    # "rbbfb_0024-01_all-episodes.csv",
    # "agent_8_0024-01_all-episodes.csv",
    "agent_8_0120-01_all-episodes.csv",
    # "agent_7_0024-01_all-episodes.csv",
    # "agent_9_0024-01_all-episodes.csv",
    # "agent_12_0024-01_all-episodes.csv",
