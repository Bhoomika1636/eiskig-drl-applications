...
# schedule = [(0.7, 0.005), (0.4, 0.002), (0.2, 0.001)]

# import matplotlib.pyplot as plt
# import numpy as np

# # Create instances of the schedulers
# cosine_annealing_scheduler = WarmupCosineAnnealingLR(begin_lr, base_lr, final_lr, warmup_proportion)
# piecewise_constant_scheduler = WarmupPiecewiseConstantLR(begin_lr, base_lr, schedule, warmup_proportion)

# # Generate progress values and compute learning rates
# progress_values = np.linspace(0, 1, 1000)
# cosine_annealing_lrs = [cosine_annealing_scheduler.value(progress) for progress in progress_values]
# piecewise_constant_lrs = [piecewise_constant_scheduler.value(progress) for progress in progress_values]

# # Plot the learning rate schedules
# plt.figure(figsize=(12, 6))
# plt.plot(progress_values, cosine_annealing_lrs, label='Warmup Cosine Annealing LR')
# # plt.plot(progress_values, piecewise_constant_lrs, label='Warmup Piecewise Constant LR')
