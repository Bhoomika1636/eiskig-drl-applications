...
experiment_list = [
    {
        "fmu_output_to_csv_target": {"Temp_storage_heat_upper": "s_temp_heat_storage_hi"},
        "PI_days": {
            60: ["chp_variance"],
            132: ["chp_variance"],
            308: ["chp_variance"],
    ...
    },
    {
        ...
        "PI_days": {
            60: ["coolingTower_open_variance", "idealPump1_variance"],
            132: ["compressionChiller_CT_variance", "idealPump1_variance"],
            308: ["coolingTower_open_variance"],
        },
    },
]
...
for experiment in experiment_list:
    ...
    for day in list(PI_days.keys()):
        ...
        # define run name
        run_name = str(next(iter(fmu_output_to_csv_target.values()))) + "_day_" + str(day)
        # perform PI
        pi_result = fmuParameterIdentification(
            initial_guess=[0.9] * len(selected_keys),
            diff_step=0.1,
            plot=False,
