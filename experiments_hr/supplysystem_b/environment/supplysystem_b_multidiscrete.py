...
class SupplysystemB(BaseEnvSim):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        state_var_tuple = (
            ...
            StateVar(
                name="s_temp_heat_storage_mid",
                ext_id="TempSen_storage_heat_middle.T",
                is_ext_output=True,
                is_agent_observation=True,
                abort_condition_min=273.15 + 15,
                abort_condition_max=273.15 + 97,
            ...
            StateVar(
                name="s_temp_cold_storage_mid",
                ext_id="TempSen_storage_cold_middle.T",
                is_ext_output=True,
                is_agent_observation=True,
                abort_condition_min=273.15 + 1,
                abort_condition_max=273.15 + 60,
    ...
    def reset(
        ...
        *,
        ...
        # function to load parameters into self.model_parameters one by one, insuring same number of random calls in each case for reproducability
        self.std_dev = 1 / 6 * (self.variance_max - self.variance_min)

        def get_parameter(name: str, distribution: str, v_min: float, v_max: float):
            if distribution == "uniform":
                self.model_parameters[name] = self.np_random.uniform(v_min, v_max)
            elif distribution == "normal":
                self.model_parameters[name] = max(
                    min(self.np_random.normal(loc=self.model_parameters.get(name, 1.0), scale=self.std_dev), v_max),
                    v_min,
                )
            elif distribution == "fixed":
                _ = self.np_random.uniform(v_min, v_max)
            return

        # load parameters into self.model_parameters according to the desired distribution
        get_parameter("pipe_simple_chp_variance", self.distribution, self.variance_min, self.variance_max)
        get_parameter("pipe_simple_boiler_variance", self.distribution, self.variance_min, self.variance_max)
        get_parameter(
            "pipe_simple_CompressionChiller_warm_side_variance", self.std_dev, self.variance_min, self.variance_max
        )
        get_parameter(
            "pipe_simple_CompressionChiller_cold_side_variance", self.std_dev, self.variance_min, self.variance_max
        )
        get_parameter("pipe_simple_production1_variance", self.distribution, self.variance_min, self.variance_max)
        get_parameter("pipe_simple_production2_variance", self.distribution, self.variance_min, self.variance_max)
        get_parameter(
            "pipe_simple_CompressionChiller2_variance", self.distribution, self.variance_min, self.variance_max
        )
        get_parameter("pipe_simple_CoolingTower_variance", self.distribution, self.variance_min, self.variance_max)
        get_parameter("watertank_warm_variance", self.distribution, self.variance_min, self.variance_max)
        get_parameter("watertank_cold_variance", self.distribution, self.variance_min, self.variance_max)
        get_parameter("val_after_HeatPump_variance", self.distribution, self.variance_min, self.variance_max)
        get_parameter("val_before_CoolingTower_variance", self.distribution, self.variance_min, self.variance_max)
        get_parameter("heatExchanger_counterflow_variance", self.distribution, self.variance_min, self.variance_max)
        get_parameter("idealPump2_variance", self.distribution, self.variance_min, self.variance_max)
        get_parameter("idealPump3_variance", self.distribution, self.variance_min, self.variance_max)
        get_parameter("idealPump4_variance", self.distribution, self.variance_min, self.variance_max)
        get_parameter("idealPump5_variance", self.distribution, self.variance_min, self.variance_max)
        get_parameter("idealPump1_variance", self.distribution, self.variance_min, self.variance_max)
        get_parameter("idealPump_variance", self.distribution, self.variance_min, self.variance_max)
        get_parameter("coolingTower_open_variance", self.distribution, self.variance_min, self.variance_max)
        get_parameter("chp_variance", self.distribution, self.variance_min, self.variance_max)
        get_parameter("condensingBoiler_variance", self.distribution, self.variance_min, self.variance_max)
        get_parameter("immersionHeater_variance", self.distribution, self.variance_min, self.variance_max)
        get_parameter("compressionChiller_Tanks_variance", self.distribution, self.variance_min, self.variance_max)
        get_parameter("compressionChiller_CT_variance", self.distribution, self.variance_min, self.variance_max)
        ...
        self.model_parameters["T_start_warmwater_mid"] = (
            self.model_parameters["T_start_warmwater"] - self.temperature_difference_top_bottom / 2
        )
        self.model_parameters["T_start_warmwater_low"] = (
        ...
        self.model_parameters["T_start_coldwater_mid"] = (
            self.model_parameters["T_start_coldwater"] + self.temperature_difference_top_bottom / 2
        )
        self.model_parameters["T_start_coldwater_up"] = (
            self.model_parameters["T_start_coldwater"] + self.temperature_difference_top_bottom
        )

        # set additianal state
        self.additional_state["s_temp_heat_storage_hi"] = self.model_parameters["T_start_warmwater"]
        self.additional_state["s_temp_heat_storage_mid"] = self.model_parameters["T_start_warmwater_mid"]
        self.additional_state["s_temp_heat_storage_lo"] = self.model_parameters["T_start_warmwater_low"]
        self.additional_state["s_temp_cold_storage_lo"] = self.model_parameters["T_start_coldwater"]
        self.additional_state["s_temp_cold_storage_mid"] = self.model_parameters["T_start_coldwater_mid"]
        self.additional_state["s_temp_cold_storage_hi"] = self.model_parameters["T_start_coldwater_up"]
