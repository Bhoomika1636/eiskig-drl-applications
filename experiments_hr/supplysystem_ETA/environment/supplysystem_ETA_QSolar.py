...
class SupplysystemETA(BaseEnvSim):
    ...
    fmu_name = "supplysystem_ETA_PIAFA"  # this model has the new AFA model included, which needs solar radiation and wind speed as inputs - also P_el of all pumps are now inlcuded in the total P_el
        ...
        **kwargs: Any,
        ...
        state_var_tuple = (
            ...
            StateVar(
                ...
                ext_id="Q_solar_irradiation",
                scenario_id="global_radiation",  # [°C]
                from_scenario=True,
                is_ext_input=True,
                low_value=0,
                high_value=200,
    ...
    def render(self, mode="human", name_suffix=""):
        ...
        axes[5].plot(
            x,
            y["wind_speed"].to_numpy(),
            color=(100 / 255, 50 / 255, 0 / 255),
            label="Windgeschwindigkeit",
        )
        axes[5].plot(
            x,
            y["global_radiation"].to_numpy(),
            color=(192 / 255, 0, 0),
