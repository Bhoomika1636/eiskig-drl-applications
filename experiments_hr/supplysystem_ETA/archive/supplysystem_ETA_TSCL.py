...
from eta_utility.eta_x.common.policies import NoPolicy
...
"""
Important notes about the current implementation progress:

- The FMU used here, is directly exported from the TSCL Library: https://github.com/PTW-TUDa/ThermalSystemsControlLib
- The actions for the supply systems are already defined
- The algorithm mode could be set to true as default in the simulation model
- The disturbances (consumer heat flows) are not defined yet
- The ambient state is not defined yet
- To define the disturbances and ambient state, adjustents in the simulation model are neccessary


changes made by Tobias Lademann
...
class SupplysystemETA(BaseEnvSim):
    ...
    fmu_name = "eta_heating_systems_TSCL"
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        """
        # This was commented out, because no variant selection is possible
        ...
        state_var_tuple = (
            ...
            StateVar(
                ...
                ext_id="HNLT_CN.HeatPumpSystem.control.bSetStatusOnAlgorithm",
                is_ext_input=True,
                is_agent_action=True,
                low_value=0.0,
                high_value=1.0,
            ...
            StateVar(
                name="bSetStatusOn_HeatPump2",
                ext_id="HNHT_HNLT.HeatPumpSystem.control.bSetStatusOnAlgorithm",
                is_ext_input=True,
                is_agent_action=True,
                low_value=0.0,
                high_value=1.0,
            ...
            StateVar(
                ...
                ext_id="HNHT_HNLT.HeatExchanger1System.selectControlMode.bSetStatusOn",
                is_ext_output=True,
                is_agent_observation=True,
            ),
            StateVar(
                name="Out_bSetStatusOn_CHP1",
                ext_id="HNHT.CHP1System.selectControlMode.bSetStatusOn",
                is_ext_output=True,
                is_agent_observation=True,
            ),
            StateVar(
                name="Out_bSetStatusOn_CHP2",
                ext_id="HNHT.CHP2System.selectControlMode.bSetStatusOn",
                is_ext_output=True,
                is_agent_observation=True,
            ),
            StateVar(
                name="Out_bSetStatusOn_CondensingBoiler",
                ext_id="HNHT.CondensingBoilerSystem.selectControlMode.bSetStatusOn",
                is_ext_output=True,
                is_agent_observation=True,
            ),
            StateVar(
                name="Out_bSetStatusOn_VSIStorage",
                ext_id="HNHT.VSIStorageSystem.selectControlMode.bSetStatusOn",
                is_ext_output=True,
                is_agent_observation=with_storages,
            ),
            StateVar(
                name="Out_bLoading_VSISystem",
                ext_id="HNHT.VSIStorageSystem.selectLocalControlModeBoolean.bLoading",  # no variable available
                is_ext_output=True,
                is_agent_observation=with_storages,
            ),
            StateVar(
                name="Out_bSetStatusOn_HVFASystem_HNLT",
                ext_id="HNLT.HVFASystem.selectControlMode.bSetStatusOn",
                is_ext_output=True,
                is_agent_observation=with_storages,
            ),
            StateVar(
                name="Out_bLoading_HVFASystem_HNLT",
                ext_id="HNLT.HVFASystem.selectLocalControlModeBoolean.bLoading",
                is_ext_output=True,
                is_agent_observation=with_storages,
            ),
            StateVar(
                name="Out_bSetStatusOn_eChiller",
                ext_id="CN.eChillerSystem.selectControlMode.bSetStatusOn",
                is_ext_output=True,
                is_agent_observation=True,
            ),
            StateVar(
                name="Out_bSetStatusOn_HVFASystem_CN",
                ext_id="CN.HVFASystem.selectControlMode.bSetStatusOn",
                is_ext_output=True,
                is_agent_observation=with_storages,
            ),
            StateVar(
                name="Out_bLoading_HVFASystem_CN",
                ext_id="CN.HVFASystem.selectLocalControlModeBoolean.bLoading",
                is_ext_output=True,
                is_agent_observation=with_storages,
            ),
            StateVar(
                name="Out_bSetStatusOn_OuterCapillaryTubeMats",
                ext_id="HNLT.OuterCapillaryTubeMats.selectControlMode.bSetStatusOn",
                is_ext_output=True,
                is_agent_observation=True,
            ),
            StateVar(
                name="Out_bSetStatusOn_HeatPump",
                ext_id="HNLT_CN.HeatPumpSystem.selectControlMode.bSetStatusOn",
                is_ext_output=True,
                is_agent_observation=True,
            ),
            StateVar(
                name="Out_bSetStatusOn_HeatPump2",
                ext_id="HNHT_HNLT.HeatPumpSystem.selectControlMode.bSetStatusOn",
                is_ext_output=True,
                is_agent_observation=True,
            ),
            # add others here too
            ...
            #     ext_id="HNHT_StaticHeatingSystem_fHeatFlowRate",
            ...
            # ),
            # StateVar(
            #     name="HNLT_CompressorSystem_fHeatFlowRate",
            #     ext_id="HNLT.CompressorSystem.fHeatFlowRate",
            ...
            #     ext_id="CN_CentralMachineCoolingSystem_fHeatFlowRate",
            ...
            # ),
            # StateVar(
            #     name="CN_CentralMachineCoolingSystem_bAlgorithmModeActivated",
            ...
            # ),
            # StateVar(
            #     name="CN_CentralMachineCoolingSystem_bSetStatusOnAlgorithm",
            ...
            # debugging variables
            StateVar(
                name="CN.CentralMachineCoolingSystem.WMZ100.fHeatFlowRate",
                ext_id="CN.CentralMachineCoolingSystem.WMZ100.fHeatFlowRate",
                is_ext_output=True,
            ),
            StateVar(
                name="CN.CentralMachineCoolingSystem.selectControlMode.bSetStatusOn",
                ext_id="CN.CentralMachineCoolingSystem.selectControlMode.bSetStatusOn",
                is_ext_output=True,
            ),
            StateVar(
                name="CN.CentralMachineCoolingSystem.CentralMachineCooling.Q_flow",
                ext_id="CN.CentralMachineCoolingSystem.CentralMachineCooling.Q_flow",
                is_ext_output=True,
            ),
            # StateVar(
            #     name="weather_T_amb",
            #     ext_id="Ambient.ambientState.fOutsideTemperature",
            ...
            #     ext_id="Ambient.ambientState.fOutsideTemperature_Mean",
            ...
            StateVar(
                ...
                ext_id="HNHT.CHP1System.CHP.cHP_Physical.P_gas",  # ToDO: zu Gesamtleistung ändern
                is_ext_output=True,
                low_value=0,
                high_value=500000,
            ),
            ...
            StateVar(
                ...
                ext_id="HNHT.CHP1System.CHP.cHP_Physical.P_el",  # ToDO: zu Gesamtleistung ändern
                is_ext_output=True,
                low_value=-100000,
                high_value=500000,
            ),
            ...
            StateVar(
                ...
                ext_id="HNLT.localState.fUpperTemperature_ActiveStorage",
                is_ext_output=True,
                is_agent_observation=extended_observations,
            ...
            StateVar(
                ...
                ext_id="HNLT.localState.fLowerTemperature_ActiveStorage",
                is_ext_output=True,
                is_agent_observation=with_storages,
                abort_condition_min=1,
                abort_condition_max=97,
            ...
            StateVar(
                ...
                ext_id="CN.localState.fUpperTemperature_ActiveStorage",
                is_ext_output=True,
                is_agent_observation=extended_observations,
                abort_condition_min=1,
                abort_condition_max=97,
            ...
            StateVar(
                ...
                ext_id="CN.localState.fLowerTemperature_ActiveStorage",
                is_ext_output=True,
                is_agent_observation=with_storages,
                abort_condition_min=1,
                abort_condition_max=97,
            ...
            StateVar(
                ...
                ext_id="HNHT.localState.fUpperTemperature_ActiveStorage",
                is_ext_output=True,
                is_agent_observation=with_storages,
                abort_condition_min=15,
                abort_condition_max=97,
            ...
            #     ext_id="HNHT.VSIStorageSystem.localStorageState.fMidTemperature",
            #     is_ext_output=True,
            #     is_agent_observation=extended_observations,
            #     abort_condition_min=15,
            #     abort_condition_max=97,
            ...
            StateVar(
                ...
                ext_id="HNHT.localState.fLowerTemperature_ActiveStorage",
                is_ext_output=True,
                is_agent_observation=with_storages,
                abort_condition_min=15,
                abort_condition_max=97,
            ...
            ## Activate Algorithm Permissions
            StateVar(
                name="HeatExchanger1_bAlgorithmModeActivated",
            ...
            StateVar(
                name="CHP1_bAlgorithmModeActivated",
            ...
            StateVar(
                name="CHP2_bAlgorithmModeActivated",
            ...
            StateVar(
                name="CondensingBoiler_bAlgorithmModeActivated",
            ...
            StateVar(
                name="VSIStorage_bAlgorithmModeActivated",
            ...
            StateVar(
                name="OuterCapillaryTubeMats_bAlgorithmModeActivated",
            ...
            StateVar(
                name="eChiller_bAlgorithmModeActivated",
            ...
            StateVar(
                name="HVFASystem_CN_bAlgorithmModeActivated",
            ...
            StateVar(
                name="HVFASystem_HNLT_bAlgorithmModeActivated",
            ...
            StateVar(
                name="HeatPump_bAlgorithmModeActivated",
                ext_id="HNLT_CN.HeatPumpSystem.control.bAlgorithmModeActivated",
                is_ext_input=True,
                is_agent_action=True,
                low_value=0,
                high_value=1,
            ...
            StateVar(
                name="HeatPump2_bAlgorithmModeActivated",
                ext_id="HNHT_HNLT.HeatPumpSystem.control.bAlgorithmModeActivated",
                is_ext_input=True,
                is_agent_action=True,
                low_value=0,
                high_value=1,
            ...
            #### Debugging Variables ####
            StateVar(
                name="HNHT_AlgorithmPermission", ext_id="Strategy.hnhtControl.bAlgorithmPermission", is_ext_output=True
            ),
            StateVar(
                name="HNLT_AlgorithmPermission", ext_id="Strategy.hnltControl.bAlgorithmPermission", is_ext_output=True
            ),
            StateVar(
                name="CN_AlgorithmPermission", ext_id="Strategy.cnControl.bAlgorithmPermission", is_ext_output=True
            ),
            StateVar(
                name="CHP1_AlgorithmModeActivated",
                ext_id="HNHT.CHP1System.control.bAlgorithmModeActivated",  # no variable available
                is_ext_output=True,
            ),
            StateVar(
                name="VSI_AlgorithmModeActivated",
                ext_id="HNHT.VSIStorageSystem.control.bAlgorithmModeActivated",  # no variable available
                is_ext_output=True,
            ),
        )
    ...
    def calc_reward(self, action):
        ...
        self.poweron_cost_HVFASystem_CN = poweron_cost_HVFASystem_CN
        self.poweron_cost_OuterCapillaryTubeMats = poweron_cost_OuterCapillaryTubeMats
        self.poweron_cost_HeatPump = poweron_cost__HeatPump
        self.switching_cost_bLoading_HVFASystem_CN = switching_cost_bLoading_HVFASystem_CN
        """
    ...
    def reset(self) -> np.ndarray:
        ...
        # self.additional_state["init_HNHT_buffer"] = 341.11
        ...
        #     self.ts_current["air_temperature"][0]+273.15, self.ts_current["air_temperature"][0]+273.15)
    ...
    def render_episodes(self):
        ...
        axes[1].plot(x, y["reward_temperature_HNHT"], label="HNHT", color=(0.75, 0, 0), linewidth=1, alpha=0.9)
        axes[1].plot(x, y["reward_temperature_HNLT"], label="HNLT", color=(0, 0.75, 0.25), linewidth=1, alpha=0.9)
        axes[1].plot(x, y["reward_temperature_CN"], label="CN", color=(0.36, 0.61, 0.84), linewidth=1, alpha=0.9)
        axes[1].plot(
    ...
    def render(self, mode="human", name_suffix=""):
        ...
        axes[0].set_yticks(np.arange(14))
        ...
        axes[1].plot(
            x,
            [self.HNHT_temperature_reward_min_T] * len(x),
        ...
        axes[1].plot(
            x,
            [self.HNHT_temperature_reward_max_T] * len(x),
            color=(50 / 255, 50 / 255, 50 / 255),
            linestyle=":",
            label="HNHT T_max",
        )
        ...
        axes[1].plot(
            x, y["HNHT_Buffer_fUpperTemperature"], color=(192 / 255, 0, 0), linestyle="--", label="HNHT Buffer (oben)"
        )
        axes[1].plot(x, y["HNHT_Buffer_fMidTemperature"], color=(192 / 255, 0, 0), label="HNHT Buffer (mitte)")
        axes[1].plot(
            x, y["HNHT_Buffer_fLowerTemperature"], color=(192 / 255, 0, 0), linestyle="--", label="HNHT Buffer (unten)"
        )

        axes[1].plot(
            x,
            y["HNHT_VSI_fUpperTemperature"],
            color=(230 / 255, 125 / 255, 60 / 255),
            linestyle="--",
            label="VSI Speicher (oben)",
        )
        # axes[1].plot(x,y["HNHT_VSI_fMidTemperature"],
        #     color=(230 / 255, 125/255, 60/255),label="VSI Speicher (mitte)")
        axes[1].plot(
            x,
            y["HNHT_VSI_fLowerTemperature"],
            color=(230 / 255, 125 / 255, 60 / 255),
            linestyle="--",
        ...
        axes[2].plot(
            x,
            [self.HNLT_temperature_reward_min_T] * len(x),
            color=(50 / 255, 50 / 255, 50 / 255),
            linestyle=":",
            label="HNLT T_min",
        )
        axes[2].plot(
            x,
            [self.HNLT_temperature_reward_max_T] * len(x),
            color=(50 / 255, 50 / 255, 50 / 255),
            linestyle=":",
            label="HNLT T_max",
        )
        ...
        axes[2].plot(
            x,
            y["HNLT_Buffer_fUpperTemperature"],
            color=(70 / 255, 195 / 255, 60 / 255),
            linestyle="--",
            label="HNLT Buffer (oben)",
        )
        axes[2].plot(
            x, y["HNLT_Buffer_fMidTemperature"], color=(70 / 255, 195 / 255, 60 / 255), label="HNLT Buffer (mitte)"
        )
        axes[2].plot(
            x,
            y["HNLT_Buffer_fLowerTemperature"],
            color=(70 / 255, 195 / 255, 60 / 255),
            linestyle="--",
        ...
        axes[3].plot(
            x,
            [self.CN_temperature_reward_min_T] * len(x),
            color=(50 / 255, 50 / 255, 50 / 255),
            linestyle=":",
            label="CN T_min",
        )
        axes[3].plot(
            x,
            [self.CN_temperature_reward_max_T] * len(x),
            color=(50 / 255, 50 / 255, 50 / 255),
            linestyle=":",
            label="CN T_max",
        )
        ...
        axes[3].plot(
            x,
            y["CN_Buffer_fUpperTemperature"],
            color=(91 / 255, 155 / 255, 213 / 255),
            linestyle="--",
            label="CN Buffer (oben)",
        )
        axes[3].plot(
            x, y["CN_Buffer_fMidTemperature"], color=(91 / 255, 155 / 255, 213 / 255), label="CN Buffer (mitte)"
        )
        axes[3].plot(
            x,
            y["CN_Buffer_fLowerTemperature"],
            color=(91 / 255, 155 / 255, 213 / 255),
            linestyle="--",
        ...
        # axes[4].plot(x,y["d_HNHT_prod_heat_demand_consumer"]/1000,
        #     color=(192 / 255, 0, 0),label="HNHT Verbraucher",
        # )
        # # axes[4].plot(x,y["d_HNHT_prod_heat_demand_producer"]/1000,
        # #     color=(192 / 255, 0, 0),linestyle="--",label="HNHT Erzeuger",
        # # )

        # axes[4].plot(x,y["d_HNLT_prod_heat_demand_consumer"]/1000,
        #     color=(70 / 255, 195 / 255, 60 / 255),label="HNLT Verbraucher",
        # )
        # axes[4].plot(x,y["d_HNLT_prod_heat_demand_producer"]/1000,
        #     color=(70 / 255, 195 / 255, 60 / 255),linestyle="--",label="HNLT Erzeuger",
        # )
        # axes[4].plot(x,y["d_CN_prod_heat_demand_consumer"]/1000,
        #     color=(91 / 255, 155 / 255, 213 / 255),label="CN Verbraucher",
        # )
        ...
        # axes[5].plot(x,y["weather_T_amb"],
        #     color=(255 / 255, 128 / 255, 0 / 255),label="Außentemperatur",
        # )
        # axes[5].plot(x,y["weather_T_amb_Mean"],
        #     color=(100 / 255, 50 / 255, 0 / 255),linestyle="--",label="Außentemperatur Mean 6h",
        # )
        # axes[5].plot(x,y["weather_T_Ground_1m"],
        #     color=(204 / 255, 0 / 255, 204 / 255),label="Bodentemperatur (1m)",
        # )
        ...
        axes[6].plot(
            x,
            y["reward_temperature_HNHT"].cumsum(),
            label="HNHT",
            color=(0.75, 0, 0),
            linewidth=1,
            alpha=0.9,
        ...
        axes[6].plot(
            x,
            y["reward_temperature_HNLT"].cumsum(),
            label="HNLT",
            color=(50 / 255, 50 / 255, 50 / 255),
            linewidth=1,
            alpha=0.9,
        ...
        axes[6].plot(
            x,
            y["reward_temperature_CN"].cumsum(),
            label="CN",
    ...
    def control_rules(self, observation) -> np.ndarray:
        ...
        raise NotImplemented  # raise NotImplemented since "old" fallback strategy is implemented
